...
## Project Structure
    ...
    ├── testapiautoconnecto_61884  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_61884`
...
2. Clone this repo and `cd testapiautoconnecto_61884`
